...
<body leftmargin="0" topmargin="0" bottommargin="0" rightmargin="0"
	...
	<div id="container">
		...
		<p class="center">Click <a href="cats/1">here</a> to start rating funny cats</p>

        <ul id="cats">
		<c:forEach items="${cats}" var="cat">
		  <li><img height="100px" src="<c:url value="/resources/cats/${cat.value.fileName}" />" alt="Funny Cat"
                title="Funny Cat" /> - ${cat.value.rating}</li>
		</c:forEach>
		</ul>
